    ...
    <Container>
      ...
      {active ? (
        <>
          ...
          {isStaking && <Guarding className='shadow'>* You are having an adventure *</Guarding>}
          {/* <KeyPointContainer>
            <Collapse
              bordered={false}
            ...
            >
              <Panel header={<Typography className="shadow underline"  >
                ...
                <Typography className="shadow left" $size="10px" m="10px 0 ">
                  Have an adventure by staking your NFTs to earn $GEM
                </Typography>
                <Typography className="shadow left" $size="10px" m="10px 0 ">
                  20% Tax on all claimed $GEM is paid to hunters
                </Typography>
                <Typography className="shadow left" $size="10px" m="10px 0 ">
                  $GEM can be used to mint more adventurers and hunters
                </Typography>
                <Typography className="shadow left" $size="10px" m="10px 0 0 ">
                  Hunters can steal mints
                </Typography>
              </Panel>
            </Collapse>
